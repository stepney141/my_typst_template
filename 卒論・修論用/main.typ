...
#appendix[
  ...
  このテンプレートでは、コンテンツの周囲を `#appendix[]` で囲むと、そのコンテンツはそのまま付録セクションになります。ナンバリング方式もアルファベットに変わります。

  ```typ
  #appendix[
    = こういう機能もいるよね

    このテンプレートでは、コンテンツの周囲を `#appendix[]` で囲むと、そのコンテンツはそのまま付録セクションになります。ナンバリング方式もアルファベットに変えてありますよ！
  ]
  ```
]
